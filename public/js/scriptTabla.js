...
function submitUpdateForm(event) {
    ...
    const birthdateValue = document.getElementById('updateBirthdate').value;

    const updatedData = {
        name: document.getElementById('updateName').value,
        birthdate: birthdateValue ? birthdateValue : null, // Si está vacío, enviar null
    ...
    console.log('Datos enviados al servidor:', updatedData); // Para depuración
